...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-light">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3 fw-bold" href="{{ url('dashboard') }}">Laravel Mart Database</a>
            <!-- Sidebar Toggle-->
                                        ...
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs fw-bold text-uppercase mb-1">
                                                    Jumlah Buyer</div>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $jumlah_byr }}</div>
                                            </div>
                                            <div class="col-auto">
                                    ...
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs fw-bold text-uppercase mb-1">
                                                    Jumlah Seller</div>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $jumlah_seller }}</div>
                                            </div>
                                            <div class="col-auto">
                            ...
                            <div class="col-xl-6">
                                <div class="card mb-4">
                                    <div class="card-header">
                                        ...
                                        Jumlah Seller Berdasarkan Usia
                                    </div>
                            ...
                            <div class="col-xl-6">
                                <div class="card mb-4">
                                    <div class="card-header">
                                        ...
                                        Jumlah Buyer Berdasarkan Gender
                                    </div>
