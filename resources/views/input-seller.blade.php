            ...
            <main>
                <div class="container mt-5">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form name="add-blog-post-form" id="add-blog-post-form" method="post" action="{{url('kirim-seller')}}">
                            @csrf
                                <div class="form-group">
                                    <label for="MID">MID</label>
                                    <input type="text" id="mid" name="mid" class="form-control @error('mid') is-invalid @enderror"  value="{{ old('mid') }}">
                                    @error('mid')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="produk" name="produk" class="form-control @error('produk') is-invalid @enderror"  value="{{ old('produk') }}">
                                    @error('produk')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
